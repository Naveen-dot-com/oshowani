...
// --- API KEY (Hardcoded) ---
// Replace the value below with btoa('YOUR_ACTUAL_GEMINI_API_KEY')
// Example: btoa('AIzaSy...') in your browser console gives you the string to paste here.
// NOTE: Base64 is NOT encryption. Anyone who views your source can decode it.
const ENCRYPTED_API_KEY = 'AIzaSyDxLMQ4QeGT-ftsBrZbTaQQVi81vOzfH3g'; // <-- REPLACE THIS

let apiKey = '';
try {
    apiKey = atob(ENCRYPTED_API_KEY);
} catch (e) {
    console.error("Invalid Base64 API Key string. Replace ENCRYPTED_API_KEY with btoa('your_key').");
}
